  ...
  return (
    <>
      ...
      <div className="flex w-full">
        <div className="bg-gray-200 h-full md:h-screen w-full md:p-5 p-1">
          <div className="flex justify-between mt-2 w-full">
            ...
            <div className="w-[300px] flex gap-x-3">
              <button type="submit" className="flex py-2 px-4 border border-transparent text-sm font-medium rounded text-purple-600 hover:text-purple-700 bg-purple-100 hover:bg-purple-100 transition-colors">
              ...
              <button className="bg-white h-10 flex text-center  space-x-2 p-2 border border-transparent text-sm font-medium rounded text-gray-900 hover:text-gray-700 bg-gray-50 hover:bg-gray-100 transition-colors">
          ...
          <div className="ml-2 mt-4 border-b-2 border-gray-400">
            <ul className="flex justify-start md:flex-row gap-x-10 text-center border-b border-gray-200 text-gray-500 w-[800px]">
              <li>
          ...
          <div className="flex m-5 gap-x-3 justify-between items-center overflow-auto w-full">
            <div className="flex gap-x-2">
              <div className="group">
                <button className="bg-white text-gray-700 font-medium py-1.5 px-5 rounded inline-flex items-center">
                  <span className="mr-8">Last 30 Days</span>
                  <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />
                  </svg>
                </button>
                <ul className="absolute hidden text-gray-700 pt-1 group-hover:block">
                  <li className="">
                    <a className="rounded-t bg-white hover:bg-blue-500 hover:text-white py-2 px-4 block whitespace-no-wrap" href="#">Today</a>
                  </li>
                  <li className="">
                    <a className="bg-gray-200 bg-white hover:bg-blue-500 hover:text-white py-2 px-4 block whitespace-no-wrap" href="#">Yesterday</a>
                  </li>
                </ul>
              </div>
              ...
              <div className="group">
                <button className="bg-white text-gray-700 font-medium py-1.5 px-5 rounded inline-flex items-center">
                  <span className="mr-8">Date Type: Order Created</span>
                  <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />
                  </svg>
                </button>
              ...
              <div className="group">
                <button className="bg-white text-gray-700 font-medium py-1.5 px-5 rounded inline-flex items-center">
                  <span className="mr-8">All Orders</span>
                  <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />
                  </svg>
                </button>
              ...
              <div className="group">
                <button className="bg-white text-gray-700 font-medium py-1.5 px-5 rounded inline-flex items-center">
                  <span className="mr-8">Select Statuses</span>
                  <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />
                  </svg>
                </button>
              ...
              <button className="flex text-center bg-white space-x-2 py-2 px-4 border border-transparent text-sm font-medium rounded text-gray-900 hover:text-gray-700 bg-gray-50 hover:bg-gray-100 transition-colors">
                <span className="text-[20px]">
                  <GrFilter />
                </span>
